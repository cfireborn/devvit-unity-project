...
require_pinned_text "$compersion_template/TemplateData/style.css" "width: 332px; height: 450px" "Compersion loading-logo dimensions"
...
grep -Fq "width: 332px; height: 450px" "$build_output/TemplateData/style.css" \
